...
::: {layout-ncol="2"}
![horafuki](images/horafuki.png){height="170px"} ![bootstrap](images/real_bootstrap.png){height="170px"}
:::
...
-   イメージだが、外れ値を何度も数えてしまう<br> (FHを29回数えている)
...
-   Efron自身はABC法に未来を感じていた様子[@Efron2003-pq]
-   全く分からなければPercentile法が無難だと思う

## その他のBootstrap法について

-   BCa法は・・・・・・
-   Bootstrap t法はかなり良いが、Parametric
-   本気でやるためには専門家がいた方が良いが、ある程度はPercentile法で戦うのも一つの手だと思う
