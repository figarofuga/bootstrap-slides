...
-   最も基本は上記の**Percentile法** → ただし、**以下にのべる弱点**がある
-   Percentile法の弱点
    1.  収束が遅い
...
-   分散が分かればBootstrap-tが良いらしいが、現実的にはやや手間が増える
...
-   nは幾つにすればいいの？<br> →　Efron曰く、分散だけなら200程度、信頼区間なら1000-2000程度必要
...
1.  Bootstrapは靴の中のどの部分でしょうか？
2.  Bootstrap信頼区間を出すときには1000-2000回繰り返しをする
3.  Bootstrap信頼区間を出す前に必ず**統計量のHistogram**を確認する！
4.  Bootstrap信頼区間の時には**BCa法**を行う！
